...
const { createOrder, getOrderById, myOrders, getOrders, updateOrderById, deleteOrderById, generateSalesReport,  } = require("../controllers/orderController")
...
router.route("/admin/reports/sales").post(isAuthenticatedUser, authorizeRoles("admin"), generateSalesReport )
